...
public class ChainDealGenerator : MonoBehaviour
{
    public DateTime startDate = new DateTime(2022, 10, 01);
    public int endDateMonth = 10;
    public int endDateDay = 26;
    public string UndergroundItemName = "Icy Rock";
    ...
    void Update()
    {
        ...
        {
            DateTime endDate = endDate = new DateTime(2022, endDateMonth, endDateDay, 1, 0, 0);
            DealChain.GetDealChains(UndergroundItemsManager.Singleton.Items.Find(x => x.DisplayName == UndergroundItemName), startDate, endDate );
        }
    }
